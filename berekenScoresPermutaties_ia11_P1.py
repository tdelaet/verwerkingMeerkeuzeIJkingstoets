...
texinputFolder = "../" + jaar + "_" +  toets + "P1/texinput/"

outputFolder = "../" + jaar + "_" +  toets + "P1/output/"
if not os.path.exists(outputFolder):
    os.makedirs(outputFolder)
    
texoutputFolder = "../" + jaar + "_" +  toets + "P1/texoutput/"
...
fpunten =  open(outputFolder + toets +'_punten_uploadP1','w')
