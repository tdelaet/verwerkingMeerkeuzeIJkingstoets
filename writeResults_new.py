# -*- coding: utf-8 -*-
"""
Created on Wed Jun 18 21:52:45 2025
...
def write_scoreAllPermutations(outputbookperm_loc,nameSheet_loc,numParticipants_loc,deelnemers_loc, numQuestion_loc,content_loc,content_colNrs_loc,totalScore_loc,totalScoreDifferentPermutations_loc,columnSeries_loc):
    ...
    #deelnemersnummers
    #print deelnemers
    sheetC.cell(rowCounter, 0,"ijkID").font = Font(style_header + border_right_medium)
    rowCounter+=1
    for i in range(0,len(deelnemers_loc)):
        sheetC.cell(rowCounter,columnCounter,deelnemers_loc[i]).font = Font(font_bold + border_right_medium)
        rowCounter+=1
    columnCounter+=1;
    
    rowCounter = 1;
    #total score for indicated series
    sheetC.cell(rowCounter,columnCounter,"aangeduide reeks ",style=easyxf(style_header+border_right_medium))
    rowCounter+=1
    for i in range(len(totalScore_loc)):
        sheetC.cell(rowCounter,columnCounter,totalScore_loc[i],style=easyxf(border_right_medium))
        rowCounter+=1
    columnCounter+=1;
    ...
    for serie in range(1,numSeries_loc+1):
        rowCounter = 1;
        sheetC.cell(rowCounter,columnCounter,"reeks " + str(serie),style=easyxf(style_header+font_bold))
        rowCounter+=1
        ...
        for i in range(len(totalScore_loc)):
            ...
            if (serie == columnSeries_loc[i]):
                sheetC.cell(rowCounter,columnCounter,totalScoreSerie[i],style=easyxf(style_correctAnswer))
                ...
                if (totalScoreSerie[i]>totalScore_loc[i]):  # if score on other serie than the one indicated is higer        
                    sheetC.cell(rowCounter,columnCounter,totalScoreSerie[i],style=easyxf(style_specialAttention))
                else:
                    sheetC.cell(rowCounter,columnCounter,totalScoreSerie[i])
            rowCounter+=1                    
        columnCounter+=1;                    
...
def write_overallStatistics(outputbook_loc,nameSheet_loc,totalScore_loc,averageScore_loc,medianScore_loc,standardDeviation_loc,percentagePass_loc,numParticipantsSeries_loc,averageScoreSeries_loc,medianScoreSeries_loc,standardDeviationSeries_loc,percentagePassSeries_loc,maxTotalScore_loc):
    ...
    sheetC.cell(rowCounter,columnCounter,"aantal deelnemers",style=easyxf(font_bold))
    columnCounter+=1  
    sheetC.cell(rowCounter,columnCounter,numParticipants_loc)
    rowCounter+=1
    
    columnCounter = 0
    sheetC.cell(rowCounter,columnCounter,"gemiddelde score ",style=easyxf(font_bold))
    columnCounter+=1  
    sheetC.cell(rowCounter,columnCounter,round(averageScore_loc,2))
    rowCounter+=1
    
    columnCounter = 0
    sheetC.cell(rowCounter,columnCounter,"mediaan ",style=easyxf(font_bold))
    columnCounter+=1  
    sheetC.cell(rowCounter,columnCounter,round(medianScore_loc,2))
    rowCounter+=1

    columnCounter = 0
    sheetC.cell(rowCounter,columnCounter,"standaard deviatie",style=easyxf(font_bold))
    columnCounter+=1  
    sheetC.cell(rowCounter,columnCounter,round(standardDeviation_loc,2))
    rowCounter+=1
        
    columnCounter = 0
    sheetC.cell(rowCounter,columnCounter,"% geslaagd ",style=easyxf(font_bold))
    columnCounter+=1 
    #print totalScore_loc
    sheetC.cell(rowCounter,columnCounter,round(percentagePass_loc,2))
    ...
    for serie in range(numSeries):
        ...
        sheetC.cell(rowCounter,columnCounter,"aantal deelnemers",style=easyxf(font_bold))
        columnCounter+=1  
        sheetC.cell(rowCounter,columnCounter,numParticipantsSeries_loc[serie]) 
        rowCounter+=1
        
        columnCounter = 0
        sheetC.cell(rowCounter,columnCounter,"gemiddelde score ",style=easyxf(font_bold))
        columnCounter+=1  
        sheetC.cell(rowCounter,columnCounter,round(averageScoreSeries_loc[serie],2))
        rowCounter+=1
        
        columnCounter = 0
        sheetC.cell(rowCounter,columnCounter,"mediaan ",style=easyxf(font_bold))
        columnCounter+=1  
        sheetC.cell(rowCounter,columnCounter,round(medianScoreSeries_loc[serie],2))
        rowCounter+=1
        
        columnCounter = 0
        sheetC.cell(rowCounter,columnCounter,"standaard deviatie ",style=easyxf(font_bold))
        columnCounter+=1  
        sheetC.cell(rowCounter,columnCounter,round(standardDeviationSeries_loc[serie],2))
        rowCounter+=1
        ...
        columnCounter+=1 
        #print totalScore_loc
        sheetC.cell(rowCounter,columnCounter,round(percentagePassSeries_loc[serie],2))
...
def write_averageScoreQuestions(outputbook_loc,nameSheet_loc,numQuestions_loc,averageScore_loc,averageScoreUpper_loc,averageScoreMiddle_loc,averageScoreLower_loc,averageScoreQuestions_loc,averageScoreQuestionsUpper_loc,averageScoreQuestionsMiddle_loc,averageScoreQuestionsLower_loc,averageScoreSeries_loc,averageScoreQuestionsDifferentSeries_loc,nameQuestions_loc,categoriesQuestions_loc):
    ...
    columnCounter = 1
    sheetC.cell(rowCounter+1,columnCounter,"all",style=easyxf(style_header + border_right_medium))
    columnCounter+=1
    ...
    sheetC.cell(rowCounter,columnCounter,"upper",style=easyxf(style_header)) 
    columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,"middle",style=easyxf(style_header)) 
    columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,"lower",style=easyxf(style_header+ border_right_medium)) 
    columnCounter+=1

    for serie in range(0,numSeries): #TODO: numseries
        sheetC.cell(rowCounter,columnCounter,"reeks " + str(serie+1) ,style=easyxf(style_header))
        columnCounter+=1
        
    sheetC.cell(rowCounter,columnCounter,"ID vraag",style=easyxf(style_header+ border_all_medium)) 
    columnCounter+=1    
    
    sheetC.cell(rowCounter,columnCounter,"categorie vraag",style=easyxf(style_header+ border_all_medium)) 
    columnCounter+=1    
    ...
    for question in range(1,numQuestions_loc+1):
        sheetC.cell(rowCounter,columnCounter,"vraag"+str(question),style=easyxf( font_bold+border_right_medium))
        columnCounter+=1        
        if averageScoreQuestions_loc[question-1]<0:
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestions_loc[question-1],3),style=easyxf(style_specialAttention + border_right_medium)        )
        else:
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestions_loc[question-1],3),style=easyxf(border_right_medium))                
        columnCounter+=1 
        if averageScoreQuestionsUpper_loc[question-1]<=averageScoreQuestionsLower_loc[question-1] or averageScoreQuestionsUpper_loc[question-1]<=averageScoreQuestionsMiddle_loc[question-1]:
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestionsUpper_loc[question-1],3),style=easyxf(style_specialAttention))
            columnCounter+=1
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestionsMiddle_loc[question-1],3),style=easyxf(style_specialAttention)) 
            columnCounter+=1
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestionsLower_loc[question-1],3),style=easyxf(style_specialAttention+ border_right_medium))    
            columnCounter+=1
        else:
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestionsUpper_loc[question-1],3))
            columnCounter+=1
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestionsMiddle_loc[question-1],3))
            columnCounter+=1
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestionsLower_loc[question-1],3),style=easyxf(border_right_medium))
            columnCounter+=1
        for serie in range(1,numSeries+1):
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestionsDifferentSeries_loc[question-1,serie-1],3))
            columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,nameQuestions_loc[question-1],style=easyxf( border_left_medium))    
        columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,categoriesQuestions_loc[question-1],style=easyxf( border_left_medium))    
        columnCounter+=1
        rowCounter+=1
        columnCounter = 0;
        
    columnCounter=0
    sheetC.cell(rowCounter,columnCounter,"totaal",style=easyxf(style_header+border_all_medium))
    columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,round(averageScore_loc,3),style=easyxf(border_righttop_medium))   
    columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,round(averageScoreUpper_loc,3),style=easyxf(border_top_medium))
    columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,round(averageScoreMiddle_loc,3),style=easyxf(border_top_medium))
    columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,round(averageScoreLower_loc,3),style=easyxf(border_righttop_medium))  
    columnCounter+=1
    for serie in range(1,numSeries+1):
        sheetC.cell(rowCounter,columnCounter,round(averageScoreSeries_loc[serie-1],3),style=easyxf(border_top_medium))
        columnCounter+=1        
...
def write_percentageAlternativesQuestions(outputbook_loc,nameSheet_loc,numQuestions_loc,correctAnswers_loc,alternatives_loc,blankAnswer_loc,numQuestionsAlternatives_loc,numParticipants_loc,nameQuestions_loc,categoriesQuestions_loc):
    ...
    for alternative in alternatives_loc+ [blankAnswer_loc]:
        sheetC.cell(rowCounter,columnCounter,alternative,style=easyxf(style_header)    )
        columnCounter+=1
        ...
        for alternative in alternatives_loc + [blankAnswer_loc]:
            if alternative == correctAnswer:
                ...
                if (numQuestionsAlternatives_loc[question-1,alternativeCounter]/numParticipants_loc < tresholdCorrectAnswer):
                    sheetC.cell(rowCounter,columnCounter,int(round(numQuestionsAlternatives_loc[question-1,alternativeCounter]/numParticipants_loc*100,0)),style = easyxf( style_correctAnswer + style_specialAttention) ) 
                else:
                    sheetC.cell(rowCounter,columnCounter,int(round(numQuestionsAlternatives_loc[question-1,alternativeCounter]/numParticipants_loc*100,0)),style = easyxf( style_correctAnswer))
            else:
                ...
                if (numQuestionsAlternatives_loc[question-1,alternativeCounter]/numParticipants_loc > tresholdWrongAnswer):
                    sheetC.cell(rowCounter,columnCounter,int(round(numQuestionsAlternatives_loc[question-1,alternativeCounter]/numParticipants_loc*100,0)),style = easyxf(style_specialAttention))
                else:
                    sheetC.cell(rowCounter,columnCounter,int(round(numQuestionsAlternatives_loc[question-1,alternativeCounter]/numParticipants_loc*100,0)))
            columnCounter+=1 
...
def write_numberAlternativesQuestions(outputbook_loc,nameSheet_loc,numQuestions_loc,correctAnswers_loc,alternatives_loc,blankAnswer_loc,numQuestionsAlternatives_loc,numParticipants_loc,nameQuestions_loc,categoriesQuestions_loc):
    ...
    for question in range(1,numQuestions_loc+1):
        ...
        for alternative in alternatives_loc + [blankAnswer_loc]:
            if alternative == correctAnswer:
                if (numQuestionsAlternatives_loc[question-1,alternativeCounter]/numParticipants_loc < tresholdCorrectAnswer):
                    sheetC.cell(rowCounter,columnCounter,round(numQuestionsAlternatives_loc[question-1,alternativeCounter],2),style = easyxf(style_correctAnswer + style_specialAttention))
                else:
                    sheetC.cell(rowCounter,columnCounter,round(numQuestionsAlternatives_loc[question-1,alternativeCounter],2),style = easyxf(style_correctAnswer)                    )
            else:
                if (numQuestionsAlternatives_loc[question-1,alternativeCounter]/numParticipants_loc > tresholdWrongAnswer):
                    sheetC.cell(rowCounter,columnCounter,round(numQuestionsAlternatives_loc[question-1,alternativeCounter],2),style = easyxf(style_specialAttention))
                else:
                    sheetC.cell(rowCounter,columnCounter,round(numQuestionsAlternatives_loc[question-1,alternativeCounter],2))
            columnCounter+=1 
            alternativeCounter+=1
        sheetC.cell(rowCounter,columnCounter,nameQuestions_loc[question-1],style=easyxf( border_left_medium))    
        columnCounter+=1    
...
def write_percentageAlternativesQuestionsUML(outputbook_loc,nameSheet_loc,numQuestions_loc,correctAnswers_loc,alternatives_loc,blankAnswer_loc,numQuestionsAlternativesUpper_loc,numQuestionsAlternativesMiddle_loc,numQuestionsAlternativesLower_loc,numUpper_loc,numMiddle_loc,numLower_loc,nameQuestions_loc,categoriesQuestions_loc):
    ...
    for alternative in alternatives_loc+ [blankAnswer_loc]:
        ...
        sheetC.cell(rowCounter+1,columnCounter,"upper",style=easyxf(style_header))
        sheetC.cell(rowCounter+1,columnCounter+1,"middle",style=easyxf(style_header))
        sheetC.cell(rowCounter+1,columnCounter+2,"lower",style=easyxf(style_header_borderRight + border_right_medium))
        columnCounter+=3
    sheetC.cell(rowCounter,columnCounter,"onderscheidend vermogen",style=easyxf(style_header)    )
    columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,"ID vraag",style=easyxf(style_header+ border_all_medium)) 
    columnCounter+=1 
    sheetC.cell(rowCounter,columnCounter,"categorie vraag",style=easyxf(style_header+ border_all_medium)) 
        ...
        for alternative in alternatives_loc + [blankAnswer_loc]:
            ...
            if alternative == correctAnswer:
                ...
                if ( (upperPerc < lowerPerc) ):
                    sheetC.cell(rowCounter,columnCounter  ,int(round(upperPerc*100,0)),style = easyxf(style_correctAnswer + style_specialAttention))
                    sheetC.cell(rowCounter,columnCounter+1,int(round(middlePerc*100,0)),style = easyxf(style_correctAnswer + style_specialAttention))
                    sheetC.cell(rowCounter,columnCounter+2,int(round(lowerPerc*100,0)),style = easyxf(style_correctAnswer+ style_specialAttention+ border_right_medium)) 
                else:
                    ...
                    if(upperPerc<tresholdUpperCorrectAnswer):                   
                        ...
                        sheetC.cell(rowCounter,columnCounter,int(round(upperPerc*100,0)),style = easyxf(style_correctAnswer) ) 
                    sheetC.cell(rowCounter,columnCounter+1,int(round(middlePerc*100,0)),style = easyxf(style_correctAnswer) )
                    sheetC.cell(rowCounter,columnCounter+2,int(round(lowerPerc*100,0)),style = easyxf( style_correctAnswer + border_right_medium))
                ...
                if (upperPerc> lowerPerc):
                    sheetC.cell(rowCounter,columnCounter,int(round(upperPerc*100,0)),style = easyxf(style_specialAttention))
                    sheetC.cell(rowCounter,columnCounter+1,int(round(middlePerc*100,0)),style = easyxf(style_specialAttention))
                    sheetC.cell(rowCounter,columnCounter+2,int(round(lowerPerc*100,0)),style = easyxf(style_specialAttention + border_right_medium) )
                else:
                    ...
                    if (numQuestionsAlternativesUpper_loc[question-1,alternativeCounter] > numQuestionsAlternativesUpper_loc[(question-1),alternatives_loc.index(correctAnswer)] ):
                        ...
                        sheetC.cell(rowCounter,columnCounter,int(round(upperPerc*100,0)))
                    sheetC.cell(rowCounter,columnCounter+1,int(round(middlePerc*100,0)))
                    sheetC.cell(rowCounter,columnCounter+2,int(round(lowerPerc*100,0)),style = easyxf(border_right_medium) ) 
            columnCounter+=3
            alternativeCounter+=1
        if diffUpperLower>=tresholdDiffUpperLowerThree:
            sheetC.cell(rowCounter,columnCounter,"++++",style=easyxf(align_horizvertcenter))
            ...
            sheetC.cell(rowCounter,columnCounter,"0",style=easyxf(align_horizvertcenter))
        columnCounter+=1
        
        sheetC.cell(rowCounter,columnCounter,nameQuestions_loc[question-1],style=easyxf( border_left_medium))    
        columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,categoriesQuestions_loc[question-1],style=easyxf(border_left_medium+border_right_medium)) 
        columnCounter+=1                
        rowCounter+=1
...
def write_histogramQuestions(outputbook_loc,nameSheet_loc,numQuestions_loc,scoreQuestionsIndicatedSeries_loc,averageScoreQuestions_loc,nameQuestions_loc,classificationQuestionsMod_loc,categoriesQuestions_loc):
    ...
    for possibleScore in possibleScores[0:len(possibleScores)-1]:
        sheetC.cell(rowCounter,columnCounter,possibleScore,style = easyxf(style_header)) 
        columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,"gemiddelde",style = easyxf(style_header))
    columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,"type vraag",style = easyxf(style_header))
    columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,"voorspelde type vraag",style=easyxf(style_header+ border_left_medium)) 
    columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,"ID vraag",style=easyxf(style_header+ border_right_medium)) 
    columnCounter+=1 
    sheetC.cell(rowCounter,columnCounter,"categorie vraag",style=easyxf(style_header+ border_right_medium)) 
    columnCounter+=1 
    ...
    for question in range(1,numQuestions_loc+1):
        ...
        for n in hist:        
            if (hist[0]>hist[len(hist)-1] or hist[0]+hist[1]>hist[len(hist)-1]+hist[len(hist)-2]): #more confident in wrong answer than confident in correct answer
                sheetC.cell(rowCounter,columnCounter,str(n),style = easyxf(style_specialAttention))
            else:
                #print (rowCounter)
                #print (columnCounter)
                #print (n)
                sheetC.cell(rowCounter,columnCounter,str(n))
            columnCounter+=1
        if averageScoreQuestions_loc[question-1]<0:
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestions_loc[question-1],2),style = easyxf(style_specialAttention)        )
        else:
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestions_loc[question-1],2)) 
        columnCounter+=1
        correctPerc= float(hist[len(hist)-1])/numParticipants
        if correctPerc > tresholdDifficultyQuestionZero:
            sheetC.cell(rowCounter,columnCounter,"0",style = easyxf(style_specialAttention+align_horizvertcenter+border_left_medium) ) 
            questionClassification.append("0")
            colClass = 0
        elif correctPerc > tresholdDifficultyQuestionOne:
            sheetC.cell(rowCounter,columnCounter,"*",style=easyxf(align_horizvertcenter+border_left_medium)) 
            ...
            sheetC.cell(rowCounter,columnCounter,"****",style=easyxf(style_specialAttention+align_horizvertcenter+border_left_medium)    )
            questionClassification.append("****")
            colClass = 4
        columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,classificationQuestionsMod_loc[question-1],style=easyxf( border_right_medium))    
        columnCounter+=1        
        sheetC.cell(rowCounter,columnCounter,nameQuestions_loc[question-1],style=easyxf( border_right_medium))    
        columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,categoriesQuestions_loc[question-1],style=easyxf(border_right_medium)) 
        columnCounter+=1        
    ...
    # # columnCounter+=2
    # # sheetC.cell(rowCounter,columnCounter,"0",style=easyxf(style_header))
    # # columnCounter+=1
    # # sheetC.cell(rowCounter,columnCounter,"*",style=easyxf(style_header))
    # # columnCounter+=1
    # # sheetC.cell(rowCounter,columnCounter,"**",style=easyxf(style_header))
    # # columnCounter+=1
    # # sheetC.cell(rowCounter,columnCounter,"***",style=easyxf(style_header))
    ...
    # #     if row ==0:
    # #         sheetC.cell(rowCounter,columnCounter,"*",style=easyxf(style_header+border_righttop_medium))
    # #     elif row==1:
    # #         sheetC.cell(rowCounter,columnCounter,"**",style=easyxf(style_header+border_right_medium))
    # #     elif row==2:
    # #         sheetC.cell(rowCounter,columnCounter,"***",style=easyxf(style_header+border_right_medium))              
    # #     columnCounter+=1
    # #     for col in range(matrixClassification.shape[1]):
    # #         sheetC.cell(rowCounter,columnCounter,matrixClassification[row][col])
    # #         columnCounter+=1
    # #     columnCounter=1
    # #     rowCounter+=1
    ...
    #     columnCounter+=1
    #     for col in range(matrixClassification.shape[1]):
    #         sheetC.cell(rowCounter,columnCounter,matrixClassificationCounter[row][col])
    #         columnCounter+=1
    #     columnCounter=1
    #     rowCounter+=1
...
def write_scoreStudents(outputbook_loc,nameSheet_loc,permutations_loc,numParticipants_loc,deelnemers_loc, numQuestions_loc,numAlternatives_loc,content_loc,content_colNrs_loc,totalScore_loc,scoreQuestionsIndicatedSeries_loc,columnSeries_loc,matrixAnswers,numberCorrectAnswers_loc,numberWrongAnswers_loc,numberBlankAnswers_loc,numberNeutralizedAnswers_loc):
    ...
    rowCounter+=1
    for i in range(0,len(deelnemers_loc)):
        sheetC.cell(rowCounter,columnCounter,deelnemers_loc[i]).font = Font(style_header + border_right_medium)
        rowCounter+=1
    columnCounter+=1;
    
    rowCounter = 0;
    #total score for indicated series
    sheetC.cell(rowCounter,columnCounter,"totale score",style=easyxf(style_header))
    rowCounter+=1
    for i in range(len(totalScore_loc)):
        sheetC.cell(rowCounter,columnCounter,totalScore_loc[i])
        rowCounter+=1
    columnCounter+=1;
    ...
    rowCounter = 0;
    #indicated series
    sheetC.cell(rowCounter,columnCounter,"reeks",style=easyxf(style_header)) 
    rowCounter+=1
    for i in range(len(totalScore_loc)):
        sheetC.cell(rowCounter,columnCounter,columnSeries_loc[i])
        rowCounter+=1
    columnCounter+=1;
    
    rowCounter = 0;
    #number of correct Answers %TODO added neutralized answers, write separate
    sheetC.cell(rowCounter,columnCounter,"aantal juist",style=easyxf(style_header)) 
    rowCounter+=1
    for i in range(len(numberCorrectAnswers_loc)):
        sheetC.cell(rowCounter,columnCounter,numberCorrectAnswers_loc[i]+numberNeutralizedAnswers_loc[i])
        rowCounter+=1
    columnCounter+=1;
    
    rowCounter = 0;
    #number of wrong Answers
    sheetC.cell(rowCounter,columnCounter,"aantal fout",style=easyxf(style_header)) 
    rowCounter+=1
    for i in range(len(numberWrongAnswers_loc)):
        sheetC.cell(rowCounter,columnCounter,numberWrongAnswers_loc[i])
        rowCounter+=1
    columnCounter+=1;
    
    rowCounter = 0;
    #number of blank Answers
    sheetC.cell(rowCounter,columnCounter,"aantal blanco",style=easyxf(style_header)) 
    rowCounter+=1
    for i in range(len(numberBlankAnswers_loc)):
        sheetC.cell(rowCounter,columnCounter,numberBlankAnswers_loc[i])
        rowCounter+=1
    columnCounter+=1;
    ...
    for question in range(1,numQuestions_loc+1):
        sheetC.cell(rowCounter,columnCounterHeader,"score vraag " + str(question),style=easyxf(style_header))
    ...
    for participant in range(len(totalScore_loc)): # loop over participants
        ...
        for question in range(1,numQuestions_loc+1):
            sheetC.cell(rowCounter,columnCounter,sorted_score[question-1])
            columnCounter+=1
        rowCounter+=1            
    ...
    for question in range(1,numQuestions_loc+1):
            rowCounter=0
            sheetC.cell(rowCounter,columnCounter,"antwoord vraag " + str(question),style=easyxf(style_header) ) 
            #print "antwoord vraag " + str(question) + str(alternative)
            answer = matrixAnswers[:,question-1]
            rowCounter+=1
            #print 
            for i in range(len(totalScore_loc)):
                sheetC.cell(rowCounter,columnCounter,answer[i])
                rowCounter+=1                    
            columnCounter+=1;    
...
def write_scoreCategoriesStudents(outputbook_loc,nameSheet_loc,deelnemers_loc,totalScore_loc, categoriesQuestions_loc, scoreCategories_loc):
    ...
    #deelnemersnummers
    sheetC.cell(rowCounter, columnCounter,"ijkID").font = Font(style_header+ border_right_medium) 
    columnCounter+=1
    sheetC.cell(rowCounter, columnCounter,"totale score").font = Font(style_header+ border_right_medium) 
    rowCounter+=1
    columnCounter=0
    
    for i in range(0,len(deelnemers_loc)):
        sheetC.cell(rowCounter,columnCounter,deelnemers_loc[i]).font = Font(style_header + border_right_medium)
        sheetC.cell(rowCounter,columnCounter+1,totalScore_loc[i]).font = Font(border_right_medium)
        rowCounter+=1
    columnCounter+=2;
    ...
    for categorie in set(categoriesQuestions_loc):
        sheetC.cell(rowCounter,columnCounter,categorie,style=easyxf(style_header))
        columnCounter+=1
    rowCounter+=1
    ...
    for deelnemer in range(scoreCategories_loc.shape[1]):
        for categorie in range(len(set(categoriesQuestions_loc))):
            sheetC.cell(rowCounter,columnCounter,scoreCategories_loc[categorie][deelnemer])
            columnCounter+=1
        rowCounter+=1
        columnCounter=columnCounterCat
...
def write_overallStatisticsInstellingen(outputbook_loc,nameSheet_loc,instellingen_loc,numParticipants_tot_loc,numParticipants_stacked_tot_loc,averageScore_tot_loc,averageScore_stacked_tot_loc,medianScore_tot_loc,medianScore_stacked_tot_loc,standardDeviation_tot_loc,standardDeviation_stacked_tot_loc,percentagePass_tot_loc,percentagePass_stacked_tot_loc):
    ...
    sheetC.cell(rowCounter,columnCounter,"aantal deelnemers",style=easyxf(font_bold))
    columnCounter+=1  
    sheetC.cell(rowCounter,columnCounter,str(numParticipants_tot_loc))
    rowCounter+=1
    
    columnCounter = 0
    sheetC.cell(rowCounter,columnCounter,"gemiddelde score ",style=easyxf(font_bold))
    columnCounter+=1  
    sheetC.cell(rowCounter,columnCounter,round(averageScore_tot_loc,2))
    rowCounter+=1
    
    columnCounter = 0
    sheetC.cell(rowCounter,columnCounter,"mediaan ",style=easyxf(font_bold))
    columnCounter+=1  
    sheetC.cell(rowCounter,columnCounter,round(medianScore_tot_loc,2))
    rowCounter+=1

    columnCounter = 0
    sheetC.cell(rowCounter,columnCounter,"standaard deviatie",style=easyxf(font_bold))
    columnCounter+=1  
    sheetC.cell(rowCounter,columnCounter,round(standardDeviation_tot_loc,2))
    rowCounter+=1
    ...
    columnCounter+=1 
    #print totalScore_loc
    sheetC.cell(rowCounter,columnCounter,round(percentagePass_tot_loc,2))
    ...
    for instelling in range(numInstellingen):
        ...
        sheetC.cell(rowCounter,columnCounter,"aantal deelnemers",style=easyxf(font_bold))
        columnCounter+=1  
        sheetC.cell(rowCounter,columnCounter,str(numParticipants_stacked_tot_loc[instelling][0]) )
        rowCounter+=1
        
        columnCounter = 0
        sheetC.cell(rowCounter,columnCounter,"gemiddelde score ",style=easyxf(font_bold))
        columnCounter+=1  
        sheetC.cell(rowCounter,columnCounter,round(averageScore_stacked_tot_loc[instelling][0],2))
        rowCounter+=1
        
        columnCounter = 0
        sheetC.cell(rowCounter,columnCounter,"mediaan ",style=easyxf(font_bold))
        columnCounter+=1  
        sheetC.cell(rowCounter,columnCounter,round(medianScore_stacked_tot_loc[instelling][0],2))
        rowCounter+=1
        
        columnCounter = 0
        sheetC.cell(rowCounter,columnCounter,"standaard deviatie ",style=easyxf(font_bold))
        columnCounter+=1  
        sheetC.cell(rowCounter,columnCounter,round(standardDeviation_stacked_tot_loc[instelling][0],2))
        rowCounter+=1
        ...
        columnCounter+=1 
        #print totalScore_loc
        sheetC.cell(rowCounter,columnCounter,round(percentagePass_stacked_tot_loc[instelling][0],2))
...
def write_distributionStudents(outputbook_loc,nameSheet_loc,numParticpants_loc,bordersDistributionStudentsLow_loc,bordersDistributionStudentsHigh_loc,distributionStudentsLow_loc,distributionStudentsHigh_loc):
    ...
    sheetC.cell(rowCounter,columnCounter,"score ",style=easyxf(font_bold+border_bottom_medium+border_right_medium))
    columnCounter+=1
    sheetC.cell(rowCounter,columnCounter,"percentage ",style=easyxf(font_bold+border_bottom_medium+border_right_medium))
    columnCounter+=1
    ...
    for score in bordersDistributionStudentsLow_loc:
        columnCounter=0
        sheetC.cell(rowCounter,columnCounter,score,style=easyxf(border_right_medium+font_bold))
        columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,round(float(distributionStudentsLow_loc[counter])/float(numParticpants_loc)*100,1))
        columnCounter+=1  
    ...
    for score in bordersDistributionStudentsHigh_loc:
        ...
        sheetC.cell(rowCounter,columnCounter,score,style=easyxf(border_right_medium+font_bold))
        columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,round(float(distributionStudentsHigh_loc[counter])/float(numParticpants_loc)*100,1))
        columnCounter+=1  
...
def write_feedbackStudents(outputbook_loc,permutations_loc,numParticipants_loc,deelnemers_loc, numQuestions_loc,alternatives_loc,numAlternatives_loc,content_loc,content_colNrs_loc,totalScore_loc,scoreQuestionsIndicatedSeries_loc,columnSeries_loc,matrixAnswers,categorieQuestions_loc,scoreCategories_loc,
    ...
    for participant in orderedParticipants: # range(len(totalScore_loc)):
        ...
        #deelnemersnummers
        sheetC.cell(rowCounter, 0,"ijkID: ").font = Font(font_bold + border_lefttop_medium) 
        columnCounter +=1
        sheetC.cell(rowCounter,columnCounter,deelnemers_loc[participant]).font = Font(font_bold + border_righttop_medium)
        
        rowCounter+=1
        columnCounter = 0
        
        #total score for indicated series
        sheetC.cell(rowCounter,columnCounter,"score",style=easyxf(border_left_medium + font_bold))
        columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,totalScore_loc[participant],style=easyxf(border_right_medium))
        
        rowCounter+=1;
        columnCounter = 0;
        
        #indicated series
        sheetC.cell(rowCounter,columnCounter,"reeks",style=easyxf(font_bold + border_leftbottom_medium)) 
        columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,columnSeries_loc[participant],style=easyxf(border_rightbottom_medium))
        rowCounter+=1;
        ...
        columnCounter=0
        counterCategorie = 0
        sheetC.cell(rowCounter,columnCounter,"",style=easyxf(border_bottom_medium))
        columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,"",style=easyxf(border_bottom_medium))
        rowCounter+=1
        columnCounter=0
        for categorie in set(categorieQuestions_loc):
            sheetC.cell(rowCounter,columnCounter,categorie,style=easyxf(font_bold + border_left_medium))
            columnCounter+=1
            sheetC.cell(rowCounter,columnCounter,scoreCategories_loc[counterCategorie][participant],style=easyxf(font_bold + border_right_medium))
            rowCounter+=1
            columnCounter-=1
            counterCategorie+=1
        sheetC.cell(rowCounter,columnCounter,"",style=easyxf(border_top_medium))
        columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,"",style=easyxf(border_top_medium))
        rowCounter+=1
        ...
        sheetC.cell(rowCounter,columnCounter,"juist",style=easyxf(font_bold + border_lefttop_medium))
        columnCounter +=1
        sheetC.cell(rowCounter,columnCounter,str(numCorrect),style=easyxf( border_righttop_medium))
        rowCounter+=1
        
        columnCounter = columnOffset
        sheetC.cell(rowCounter,columnCounter,"fout",style=easyxf(font_bold+border_left_medium))
        columnCounter +=1
        sheetC.cell(rowCounter,columnCounter,str(numWrong),style=easyxf(border_right_medium))
        rowCounter+=1
        
        columnCounter = columnOffset
        sheetC.cell(rowCounter,columnCounter,"blanco",style=easyxf(font_bold+border_leftbottom_medium))
        columnCounter +=1
        sheetC.cell(rowCounter,columnCounter,str(numBlank),style=easyxf(border_rightbottom_medium))
        rowCounter+=1
        ...
        #write heading  
        sheetC.cell(rowCounter,columnCounter,"vraag",style=easyxf(style_header))
        columnCounter+=1
        sheetC.cell(rowCounter,columnCounter,"score",style=easyxf(style_header))
        columnCounter+=1        
        sheetC.cell(rowCounter,columnCounter,"antwoord",style=easyxf(style_header))       
        columnCounter+=1       
        sheetC.cell(rowCounter,columnCounter,"sleutel",style=easyxf(style_header))       
        columnCounter+=1   
        sheetC.cell(rowCounter,columnCounter,"vraagnr.",style=easyxf(style_header)) 
        columnCounter+=1        
        sheetC.cell(rowCounter,columnCounter,"type",style=easyxf(style_header)) 
        columnCounter+=1        
        sheetC.cell(rowCounter,columnCounter,"gem.",style=easyxf(style_header))    
        columnCounter+=1        
        sheetC.cell(rowCounter,columnCounter,"upper",style=easyxf(style_header))
        columnCounter+=1        
        sheetC.cell(rowCounter,columnCounter,"lower",style=easyxf(style_header)) 
        columnCounter+=1        
        sheetC.cell(rowCounter,columnCounter,"% juist",style=easyxf(style_header))
        columnCounter+=1        
        sheetC.cell(rowCounter,columnCounter,"% blanco",style=easyxf(style_header))
        ...
        for question in range(1,numQuestions_loc+1):
            ...
            sheetC.cell(rowCounter,columnCounter,str(question),style=easyxf(font_bold + border_right_medium + align_horizright))
            columnCounter+=1
            sheetC.cell(rowCounter,columnCounter,sorted_score[int(question-1)],style=easyxf(align_horizleft))
            columnCounter+=1
            answer = matrixAnswers[participant,question-1]
            sheetC.cell(rowCounter,columnCounter,answer,style=easyxf(align_horizleft))   
            columnCounter+=1   
            sheetC.cell(rowCounter,columnCounter,correctAnswer,style=easyxf(align_horizleft))   
            columnCounter+=1  
            sheetC.cell(rowCounter,columnCounter,questionNumberSerie1,style=easyxf(align_horizleft))   
            columnCounter+=1   
            sheetC.cell(rowCounter,columnCounter,categorieQuestions_loc[int(questionNumberSerie1-1)],style=easyxf(align_horizleft))  
            columnCounter+=1;    
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestions_tot_loc[int(questionNumberSerie1-1)],2),style=easyxf(align_horizleft))  
            columnCounter+=1;    
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestionsUpper_tot_loc[int(questionNumberSerie1-1)],2),style=easyxf(align_horizleft) )
            columnCounter+=1;    
            sheetC.cell(rowCounter,columnCounter,round(averageScoreQuestionsLower_tot_loc[int(questionNumberSerie1-1)],2),style=easyxf(align_horizleft))             
            ...
            columnCounter+=1;    
            sheetC.cell(rowCounter,columnCounter,percCorrect,style=easyxf(align_horizleft))
            ...
            columnCounter+=1;    
            sheetC.cell(rowCounter,columnCounter,percBlank,style=easyxf(align_horizleft))            
            rowCounter+=1;  
...
def write_feedbackPlatform(outputFolder_loc,permutations_loc,numParticipants_loc,deelnemers_loc, numQuestions_loc,alternatives_loc,numAlternatives_loc,content_loc,content_colNrs_loc,totalScore_loc,scoreQuestionsIndicatedSeries_loc,columnSeries_loc,matrixAnswers,categorieQuestions_loc,scoreCategories_loc,
    ...
    orderedParticipants = sorted(range(len(deelnemers_loc)), key=lambda k: deelnemers_loc[k])
    # write header
    fFeedback.cell("ijkID" )
    fFeedback.cell(',')
    fFeedback.cell("reeks")
    fFeedback.cell(',')
    fFeedback.cell("score")
    fFeedback.cell(',')
    #namen categoriën
    for categorie in set(categorieQuestions_loc):
        fFeedback.cell("cat: " + categorie)
        fFeedback.cell(',')
    fFeedback.cell("aantal juist")
    fFeedback.cell(',')
    fFeedback.cell("aantal fout") 
    fFeedback.cell(',')
    fFeedback.cell("aantal blanco")
    fFeedback.cell(',')
    for question in range(1,numQuestions_loc+1):
        fFeedback.cell("vraag" + str(question) +": score")
        fFeedback.cell(',') 
        fFeedback.cell("vraag" + str(question) +": antwoord")       
        fFeedback.cell(',')
        fFeedback.cell("vraag" + str(question) +": sleutel")       
        fFeedback.cell(',')
        fFeedback.cell("vraag" + str(question) +": type") 
        fFeedback.cell(',')
        fFeedback.cell("vraag" + str(question) +": gem.")    
        fFeedback.cell(',')
        fFeedback.cell("vraag" + str(question) +": upper")
        fFeedback.cell(',')
        fFeedback.cell("vraag" + str(question) +": lower") 
        fFeedback.cell(',')
        fFeedback.cell("vraag" + str(question) + ": %juist")
        fFeedback.cell(',')
        fFeedback.cell("vraag" + str(question) +": %blanco")
        fFeedback.cell(',')  
        for alternative in alternatives_loc:
            fFeedback.cell("aantal " +alternative)
            fFeedback.cell(',')  
        fFeedback.cell("aantal " + blankAnswer_loc)
        fFeedback.cell(',')          
    fFeedback.cell('\n')
    for participant in orderedParticipants: # range(len(totalScore_loc)):
        #ijkID
        fFeedback.cell(str(int(deelnemers_loc[participant])))
        fFeedback.cell(',')
        
        #indicated series
        fFeedback.cell(str(int(columnSeries_loc[participant])))      
        fFeedback.cell(',')
        
        #total score for indicated series
        fFeedback.cell(str(int(totalScore_loc[participant])))
        fFeedback.cell(',')

        #score per categorie
        counterCategorie = 0;
        for categorie in set(categorieQuestions_loc):
            fFeedback.cell(str(scoreCategories_loc[counterCategorie][participant]))
            fFeedback.cell(',')
            counterCategorie+=1
        ...
        # aantal juist
        fFeedback.cell(str(numCorrect))
        fFeedback.cell(',')
        # aantal fout
        fFeedback.cell(str(numWrong))
        fFeedback.cell(',')
        # aantal blanco
        fFeedback.cell(str(numBlank))
        fFeedback.cell(',')
        ...
        for question in range(1,numQuestions_loc+1):
            ...
            #fFeedback.cell(str(question),style=easyxf(font_bold + border_right_medium + align_horizright))
            #columnCounter+=1
            fFeedback.cell(str(sorted_score[int(question-1)]))
            fFeedback.cell(',')
            answer = matrixAnswers[participant,int(question-1)]
            fFeedback.cell(answer)   
            fFeedback.cell(',')
            fFeedback.cell(correctAnswer)   
            fFeedback.cell(',')
            fFeedback.cell(categorieQuestions_loc[int(questionNumberSerie1-1)])  
            fFeedback.cell(',')   
            fFeedback.cell(str((round(averageScoreQuestions_tot_loc[int(questionNumberSerie1-1)],2))  ))
            fFeedback.cell(',')
            fFeedback.cell(str(int(round(averageScoreQuestionsUpper_tot_loc[int(questionNumberSerie1-1)]*100,0) )))
            fFeedback.cell(',')
            fFeedback.cell(str(int(round(averageScoreQuestionsLower_tot_loc[int(questionNumberSerie1-1)]*100,0))           )  )
 
            percCorrect = int(round(numQuestionsAlternatives_loc[int(questionNumberSerie1-1),alternatives_loc.index(correctAnswer)]/numParticipants_loc*100,0))
            fFeedback.cell(',')    
            fFeedback.cell(str(percCorrect))
            percBlank = int(round(numQuestionsAlternatives_loc[int(questionNumberSerie1-1),numAlternatives_loc]/numParticipants_loc*100,0))
            fFeedback.cell(',')
            fFeedback.cell(str(percBlank))  
            fFeedback.cell(',')
...
def write_scoreStudentsNonPermutated(outputbook_loc,nameSheet_loc,permutations_loc,numParticipants_loc,deelnemers_loc, numQuestions_loc,numAlternatives_loc,alternatives_loc,content_loc,content_colNrs_loc,totalScore_loc,scoreQuestionsIndicatedSeries_loc,columnSeries_loc,matrixAnswers):
    ...
    #deelnemersnummers
    sheetC.cell(rowCounter, 0,"studentennummer").font = Font(style_header_borderRight)
    rowCounter+=1
    for i in range(0,len(deelnemers_loc)):
        sheetC.cell(rowCounter,columnCounter,deelnemers_loc[i]).font = Font(style_header_borderRight)
        rowCounter+=1
    columnCounter+=1;
    ...
    for participant in range(len(totalScore_loc)): # loop over participants
        ...
        for question in range(1,numQuestions_loc+1):
            ...
            #    sheetC.cell(rowCounter,columnCounter,"X")
            #else:
            #    sheetC.cell(rowCounter,columnCounter,score[question-1])
            sheetC.cell(rowCounter,columnCounter,score[int(question-1)])
            columnCounter+=1
        rowCounter+=1            
    ...
    for question in range(1,numQuestions_loc+1):
        for alternative in alternatives_loc:
            sheetC.cell(0,columnCounterHeader,"antwoord vraag " + str(question) + alternative,style=easyxf(style_header))
            columnCounterHeader+=1
    rowCounter = 1;      
...
#                sheetC.cell(rowCounter,columnCounter,answersQuestion[counterAlternative])
#                columnCounter+=1
#        rowCounter+=1             
...
def write_participantsList(outputbook_loc,nameSheet_loc,deelnemers_loc):
    ...
    columnCounter = 0;
    rowCounter = 0;
    sheetC.cell(rowCounter,0,"1 tot 20")
    
    rowCounter+=1
    sheetC.cell(rowCounter,0,"Naam")
    sheetC.cell(rowCounter,1,"Voornaam")
    sheetC.cell(rowCounter,2,"Studnr")
    sheetC.cell(rowCounter,10,"TOTAAL")
    
    rowCounter+=1
    columnCounter=2
    #deelnemersnummers
    for i in range(0,len(deelnemers_loc)):
        sheetC.cell(rowCounter,columnCounter,deelnemers_loc[i])
        rowCounter+=1
...
def write_qsf(outputFolder_onderdeel_loc,numAlternatives_loc,numQuestions_loc,matrixAnswers_loc,correctAnswers_loc,deelnemers_loc,columnSeries_loc,jaar,toetsnaamOnderdeel,blankAnswer_loc):
    ...
    fqsf.cell('Snapshot,Participant,Vendor,Group')
    for question in range(1,numQuestions_loc+1):
        fqsf.cell(',Q'+str(question))
    fqsf.cell('\n')
    ...
    for participant in range(0,len(deelnemers_loc)):
        fqsf.cell(str(int(columnSeries_loc[participant]))
                   +',\"' + str(int(deelnemers_loc[participant]))
                   +'\",\"Gravic, Inc.\",\"auto\"')   
        antwoorden=matrixAnswers_numbers[participant]
        for vraag in range(0,numQuestions_loc):
            fqsf.cell(',' + str(antwoorden[vraag]))    
        fqsf.cell('\n')
        
    #write correct answers
    fqsf.cell('1,\"999999\",\"Gravic, Inc.\",\"auto\"')   
    for vraag in range(0,numQuestions_loc):
        fqsf.cell(',' + str(correctAnswers_numbers[vraag])  )
    fqsf.cell('\n')
